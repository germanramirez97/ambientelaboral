...
public class AutenticacionBean implements Serializable {
    ...
    static final Logger LOGE = LogManager.getLogger(beanUsuario.class);
    ...
    public String ingresar() {
        if (usuario == null || usuario.isEmpty() || contraseña == null || contraseña.isEmpty()) {
            ...
            LOGE.info("Algunos campos estan vacios ¡Llenalos!");
        }
        int valor;
        if (!"".equals(usuario) && !"".equals(contraseña)) {
            ...
            switch (valor) {
                case 1:
                    LOGE.info("Inocio sesion Usuario correctamente.");
                    return "PaginaUsuario";
                case 2:
                    LOGE.info("Inicio sesion Administrador correctamente.");
